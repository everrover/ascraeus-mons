 ...
 *
 * To build a sturdy brick wall, calculate all possible brick row configurations and ensure no two consecutive rows have joints aligning unless at the ends. Dynamic programming is used to count combinations.
 *
